...
# MEASUREMENT_CYCLE = [("run_swapped", 60), ("run", 60)]
# Special modes:
# LARGE_MODE = {"name": "large", "cev_a_coef": 2.0, "cev_b_coef": 2.0}
# MEASUREMENT_CYCLE = [("zero", 30), ("run", 120), (LARGE_MODE, 120)]

MEASUREMENT_CYCLE = [("zero", 60), ("run", 120), ("run_swapped", 120)]
...
def main():
    ...
    while not stop_event.is_set():
        try:
            run(args.connection, stop_event)
    ...
    device.reset_settings(
        {
            ...
            "blowers_enabled_during_zero": True,
            "zero_settling_duration": SETTLING_TIME,
            "run_settling_duration": SETTLING_TIME,
            # "raw_data_enabled": True,
            # "em_adc_oversampling": 0b0111,
        }
    )
